...
namespace DotMore.Collections.Generic
{
	...
	public class QuackingDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
	{
		...
		bool IDictionary.IsFixedSize => GetIDictionary().IsFixedSize;

		bool IDictionary.IsReadOnly => GetIDictionary().IsReadOnly;

		ICollection IDictionary.Keys => GetIDictionary().Keys;
		...
		ICollection IDictionary.Values => GetIDictionary().Values;
		...
		bool ICollection.IsSynchronized => GetIDictionary().IsSynchronized;

		object ICollection.SyncRoot => GetIDictionary().SyncRoot;
