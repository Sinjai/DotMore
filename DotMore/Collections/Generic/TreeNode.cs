...
namespace DotMore.Collections.Generic
{
	...
	public class TreeNode<T>
	{
		...
		/// </summary>
		public TreeNode<T> FirstChild => this.HasChild ? _children[0] : null;

		/// <summary>
		/// The last child node if one exists.  Null otherwise.
		/// </summary>
		public TreeNode<T> LastChild => this.HasChild ? _children[_children.Count - 1] : null;
		...
		/// </summary>
		public bool HasChild => this.ChildCount > 0;
		...
		/// </summary>
		public bool IsFirstSibling => this.PreviousSibling == null;

		/// <summary>
		/// Indicates whether this node is the last child of its parent node.
		/// </summary>
		public bool IsLastSibling => this.FollowingSibling == null;
