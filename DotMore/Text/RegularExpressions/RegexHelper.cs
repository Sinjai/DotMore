...
namespace DotMore.Text.RegularExpressions
{
	...
	public static class RegexHelper
	{
		...
		/// </summary>
		public static RegexOptions XmsOpts => RegexOptions.IgnorePatternWhitespace | RegexOptions.Multiline | RegexOptions.Singleline;

		/// <summary>
		/// Shortcut for IgnorePatternWhitespace | Multiline | Singleline | IgnoreCase.  Equivalent to Perl's "xmsi" regex options.
		/// </summary>
		public static RegexOptions XmsiOpts => XmsOpts | RegexOptions.IgnoreCase;
